...
const Header = () => {
  return (
    <div className='items-center lg:flex-row lg:items-start flex-col flex lg:pr-8 px-8  mb-[80px] md:mb-[100px]' id='home'>
      <div data-aos="fade-right"  data-aos-duration="800" className='mb-8 sm:text-xl text-l sm:mt-[120px] mt-12 text-left gpt3__header-content'>
        ...
        <div className='h-12 sm:h-[73px] flex mb-[38px] '>
          <input className=' text-white w-28 h-full outline-0 rounded-l-lg  grow flex items-center pl-8 placeholder:text-[#3D6184] bg-[#052D56] ' type="text" placeholder='Your Email Address' />
      ...
      <div  data-aos="fade-left" data-aos-duration="800">
        <img src={ai} alt="logo" className="gpt3__header-image sm:min-w-[467px] sm:h-[500px] w-[420px] h-[340px] mb-5" />
      </div>
